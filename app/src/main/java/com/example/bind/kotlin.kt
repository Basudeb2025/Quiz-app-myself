...
class kotlin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btn1 = findViewById<Button>(R.id.ktbtn1)
        val btn2 = findViewById<Button>(R.id.ktbtn2)
        dialog = Dialog(this)
        ...
        btn2.setOnClickListener {
            ...
            b.setTitle("Kotlin is use for-")
            b.setMultiChoiceItems(option,null,
